...
def parse_perf_output(perf_file):
    ...
    patterns = {
        ...
        'llc_loads_naive': r'(\d[\d,\.]*)\s+cpu_core/LLC-loads/',
        'llc_misses_naive': r'(\d[\d,\.]*)\s+cpu_core/LLC-load-misses/',
    ...
    patterns_opt = {
        ...
        'llc_loads_opt': r'(\d[\d,\.]*)\s+cpu_core/LLC-loads/',
        'llc_misses_opt': r'(\d[\d,\.]*)\s+cpu_core/LLC-load-misses/',
...
def generate_comparison_graphs(k_values, all_metrics, output_dir):
    ...
    # 3. Instructions vs K
    plt.figure(figsize=(10, 6))
    plt.plot(k_vals, instructions_naive, marker='o', label='Naive', linewidth=2, markersize=8)
    plt.plot(k_vals, instructions_opt, marker='s', label='Optimized', linewidth=2, markersize=8)
    plt.xlabel('K (number of clusters)', fontsize=12)
    ...
    plt.figure(figsize=(10, 6))
    plt.plot(k_vals, cache_hit_rate_naive, marker='o', label='Naive', linewidth=2, markersize=8)
    plt.plot(k_vals, cache_hit_rate_opt, marker='s', label='Optimized', linewidth=2, markersize=8)
    plt.xlabel('K (number of clusters)', fontsize=12)
    ...
    plt.figure(figsize=(10, 6))
    plt.plot(k_vals, cache_miss_rate_naive, marker='o', label='Naive', linewidth=2, markersize=8)
    plt.plot(k_vals, cache_miss_rate_opt, marker='s', label='Optimized', linewidth=2, markersize=8)
    plt.xlabel('K (number of clusters)', fontsize=12)
    ...
    l1_miss_rate_naive = [(all_metrics[k]['l1_misses_naive'] / all_metrics[k]['l1_loads_naive'] * 100)
                          if all_metrics[k]['l1_loads_naive'] > 0 else 0 for k in k_vals]
    l1_miss_rate_opt = [(all_metrics[k]['l1_misses_opt'] / all_metrics[k]['l1_loads_opt'] * 100)
                        if all_metrics[k]['l1_loads_opt'] > 0 else 0 for k in k_vals]
    
    plt.figure(figsize=(10, 6))
    plt.plot(k_vals, l1_miss_rate_naive, marker='o', label='Naive', linewidth=2, markersize=8)
    plt.plot(k_vals, l1_miss_rate_opt, marker='s', label='Optimized', linewidth=2, markersize=8)
    plt.xlabel('K (number of clusters)', fontsize=12)
    ...
    llc_miss_rate_naive = [(all_metrics[k]['llc_misses_naive'] / all_metrics[k]['llc_loads_naive'] * 100)
                           if all_metrics[k]['llc_loads_naive'] > 0 else 0 for k in k_vals]
    llc_miss_rate_opt = [(all_metrics[k]['llc_misses_opt'] / all_metrics[k]['llc_loads_opt'] * 100)
                         if all_metrics[k]['llc_loads_opt'] > 0 else 0 for k in k_vals]
    
    plt.figure(figsize=(10, 6))
    plt.plot(k_vals, llc_miss_rate_naive, marker='o', label='Naive', linewidth=2, markersize=8)
    plt.plot(k_vals, llc_miss_rate_opt, marker='s', label='Optimized', linewidth=2, markersize=8)
    plt.xlabel('K (number of clusters)', fontsize=12)
    ...
    # L1 Cache
    ax1.plot(k_vals, l1_miss_rate_naive, marker='o', label='Naive', linewidth=2, markersize=6)
    ax1.plot(k_vals, l1_miss_rate_opt, marker='s', label='Optimized', linewidth=2, markersize=6)
    ...
    # L2/L3 Cache (general)
    ax2.plot(k_vals, cache_miss_rate_naive, marker='o', label='Naive', linewidth=2, markersize=6)
    ax2.plot(k_vals, cache_miss_rate_opt, marker='s', label='Optimized', linewidth=2, markersize=6)
    ...
    # LLC (L3)
    ax3.plot(k_vals, llc_miss_rate_naive, marker='o', label='Naive', linewidth=2, markersize=6)
    ax3.plot(k_vals, llc_miss_rate_opt, marker='s', label='Optimized', linewidth=2, markersize=6)
