...
def generate_k_analysis_graphs(k_values, all_metrics, output_dir):
    """Gera gráficos mostrando métricas em função de K"""
    ...
    # 7. Gráfico comparativo multi-métrica (normalizado)
...
def generate_text_analysis(k_values, all_metrics, output_file):
    ...
    with open(output_file, 'w') as f:
        f.write("=" * 80 + "\n")
        f.write("  K-MEANS ANALYSIS: IMPACT OF K ON PERFORMANCE\n")
        f.write("=" * 80 + "\n\n")
